...
let
  bluetoothTune = pkgs.writeShellApplication {
    name = "bluetooth-low-latency";
...
in
{
  # fix for LogiTech MX Master 2S bluetooth mouse input delay (mostly scrolling)
  # https://www.paolomainardi.com/posts/11-linux-bluetooth-lags/

  # ensure bluetooth is enabled
  hardware.bluetooth = {
    enable = true;

    # disable USB autosuspend for btusb
    settings = { };
  };
